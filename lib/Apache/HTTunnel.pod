...
Specifies the path tpo be used for the fifo that allows communication
...
in cases when the connection cannot blocks, this directive limits the 
...
information on how to configure these faeturesl.
